...
/datum/techweb_node/clown
	...
	"honk_left_leg", "honk_right_leg", "mech_banana_mortar", "mech_mousetrap_mortar", "mech_honker", "mech_punching_face",*/ "implant_trombone", "borg_transform_clown") //SKYRAT CHANGE - Remove HONK from normal play
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
